...
#include <jetsoncar_srvs/AddTwoInts.h>

/* Include generated Message Types */
#include <jetsoncar_msgs/Test.h>
...
bool add(jetsoncar_srvs::AddTwoInts::Request  &req,
		 jetsoncar_srvs::AddTwoInts::Response &res)
{
	res.sum = req.a + req.b;
...
int main(int argc, char **argv) {
	...
	ros::Publisher pub = n.advertise<jetsoncar_msgs::Test>("test", 1000);
	jetsoncar_msgs::Test testMsg;
...
void TestServiceClient(ros::NodeHandle &n)
{
	ros::ServiceClient client = n.serviceClient<jetsoncar_srvs::AddTwoInts>("add_two_ints");
	jetsoncar_srvs::AddTwoInts srv;
	srv.request.a = 10;
	srv.request.b = 20;
	if (client.call(srv))
	{
